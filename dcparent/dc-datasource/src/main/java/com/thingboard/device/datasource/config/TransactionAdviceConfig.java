...
public class TransactionAdviceConfig {
    ...
    private static final String AOP_POINTCUT_EXPRESSION = "execution(* com.thingboard.device.base.service.impl.*.*(..)))";
    ...
    public TransactionInterceptor txadvice() {
        ...
        source.addTransactionalMethod("mod*", txattrRequired);
        ...
        source.addTransactionalMethod("sum*", txattrRequiredReadonly);
